        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="my-2">
                        <h3>About Us</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi dignissimos praesentium.</p>
                    </div>
                    <div class="my-2">
                        <h3>Contact Us</h3>
                        <div><i class="fas fa-phone-alt fa-x mr-2"></i> <span>+01067770640</span></div>
                        <div><i class="fas fa-envelope fa-x mr-2"></i> <span>Archi@gmail.com</span></div>
